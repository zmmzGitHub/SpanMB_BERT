...
####################
# data/bacteria/processed_data/json
# data/bacteria/collated_data
# --train_name
# train
# --dev_name
# dev
...
def get_args(args=None):
    ...
    parser.add_argument("--max_spans_per_doc", type=int, default=25000,
                        help="Heuristic for max spans, as square of longest sentence length")
    parser.add_argument("--max_sentences_per_doc", type=int, default=8,
