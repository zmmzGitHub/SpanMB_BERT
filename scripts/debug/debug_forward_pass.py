...
from dygie.data.dataset_readers.spanmb import DyGIEReader
from dygie.models import spanmb
...
def main():
    ...
    if args.model_archive is None:
        model = spanmb.DyGIE(vocab=vocab,
                             embedder=embedder,
                             **model_dict)
    else:
        model = spanmb.DyGIE.from_archive(args.model_archive)
