{
  SpanMB: {
    ...
    dataset_reader: {
      ...
      token_indexers: {
        bert: {
          ...
          model_name: spanmb.bert_model,
          max_length: spanmb.max_wordpieces_per_sentence
        },
      },
      max_span_width: spanmb.max_span_width
    },
    train_data_path: spanmb.data_paths.train,
    validation_data_path: spanmb.data_paths.validation,
    test_data_path: spanmb.data_paths.test,
    ...
    model: {
      ...
      loss_weights: spanmb.loss_weights,
      feature_size: 20,
      max_span_width: spanmb.max_span_width,
      target_task: spanmb.target_task,
      feedforward_params: {
        num_layers: 2,
        hidden_dims: 150,
        dropout: 0.4,
    ...
    trainer: {
      ...
      num_epochs: 40,
      grad_norm: 5.0,
      cuda_device: spanmb.cuda_device,
      validation_metric: validation_metrics[spanmb.target_task],
      optimizer: {
        type: 'adamw',
        lr: 1e-3,
        weight_decay: 0.0,
